# Generated by Django 3.2.4 on 2021-06-15 17:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Order',
            fields=[
                ('paymentMethod', models.CharField(blank=True, max_length=299, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('address', models.CharField(blank=True, max_length=299, null=True)),
                ('city', models.CharField(blank=True, max_length=299, null=True)),
                ('postal_code', models.CharField(blank=True, max_length=299, null=True)),
                ('country', models.CharField(blank=True, max_length=299, null=True)),
                ('shippingPrice', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True)),
                ('_id', models.AutoField(editable=False, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.CharField(blank=True, max_length=299, null=True)),
                ('_id', models.AutoField(editable=False, primary_key=True, serialize=False)),
